...
//Create a subclass of the Mathematician class and call it ‘divider’
public class Divider extends Mathematician {
	...
	//create a method called ‘divide’. This method take two parameters, (variables num1 & num2 that were initialized by the constructor) 
		void divide(int num1, int num2) {
			
			//divide and store the result in the initially declared variable ‘result’. 
		...
		//Create another method called ‘divide’ that will execute the same commands as the first method but this will take three parameters (num1, num2, num3).		
